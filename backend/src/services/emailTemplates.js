...
const welcomeEmail = (name) => createEmailWrapper(`
  <div class="header">
...
const loginNotificationEmail = (name, time, location = 'Unknown location') => createEmailWrapper(`
  <div class="header">
...
const orderConfirmationEmail = (name, orderNumber, total, itemsCount) => createEmailWrapper(`
  <div class="header">
...
const adminNewOrderEmail = (orderNumber, customerName, total) => createEmailWrapper(`
  <div class="header">
...
const orderStatusUpdateEmail = (name, orderNumber, oldStatus, newStatus) => createEmailWrapper(`
  <div class="header">
